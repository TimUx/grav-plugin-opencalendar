...
- Grav 2.0: OpenCalendar deklariert `compatibility.grav: ['1.7', '2.0']`. Admin Next nutzt `admin-next/fields/opencalendar_sync.js` und `/api/v1/opencalendar/*` (Grav-API-Plugin aus 2.0 erforderlich).
